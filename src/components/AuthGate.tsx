        ...
        <div className="mx-auto mt-12 w-full max-w-xl rounded-2xl border bg-white p-8 shadow-sm">
          <div className="text-center">
            ...
            <p className="mt-3 text-gray-600">
              Please sign in with Google to continue browsing Columbia dorms.
            </p>
            <button
              onClick={signInWithGoogle}
              className="mt-6 inline-flex items-center rounded-xl bg-black px-6 py-3 text-sm font-medium text-white transition hover:bg-gray-800"
            >
              <svg

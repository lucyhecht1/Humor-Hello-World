        ...
        <div className="mx-auto w-full max-w-xl">
          ...
          <div className="mb-4 overflow-hidden rounded-2xl border border-orange-200 shadow-sm">
            ...
            <div className="bg-white px-4 py-3">
              <p className="text-sm text-gray-600">Upvote or downvote AI-generated captions. It has no feelings — go wild.</p>
            </div>
          </div>
          ...
          {visibleCaptions.length === 0 ? (
            ...
            <div className="rounded-2xl border border-orange-200 bg-white p-8 text-center shadow-sm">
              <p className="font-bold text-gray-900">Your votes are in!</p>
              <p className="mt-1 text-sm text-gray-600">You&apos;ve voted on all available captions. Check back later for more.</p>
              <Link href="/" className="mt-4 inline-block rounded-xl bg-orange-600 px-5 py-2 font-anton italic text-white hover:bg-orange-700">
                GO BACK
              </Link>
            </div>
